...
st.image('fruits_vegetables_quality_predictor/deployment/fruits_vegetables.jpg')
...
model = load_model("fruits_vegetables_quality_predictor/deployment/fruit_veg_model.h5")
